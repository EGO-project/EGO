...
class TermsOfUseViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        termsOfUseLabel.text = terms
        
        // UILabel의 크기를 설정하고 contentSize에 할당
                let labelSize = termsOfUseLabel.sizeThatFits(CGSize(width: scrollView.frame.width, height: CGFloat.greatestFiniteMagnitude))
                termsOfUseLabel.frame.size = labelSize
    ...
    제1조(목적)
    이 약관은 EGO (이하 '회사' 라고 합니다)가 제공하는 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
